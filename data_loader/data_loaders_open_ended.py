...
from utils import *
from .preprocess_script_open_ended import empty_sub, build_word_vocabulary, preprocess_text
...
class MultiModalData_OpenEnded(Dataset):
    ...
    def collate_fn(self, batch):
        ...
        ans, ans_l = pad2d(collected['ans'], self.pad_index, int_dtype)
        data['que'] = que
        data['que_l'] = que_l
        data['ans'] = ans
        data['ans_l'] = ans_l
